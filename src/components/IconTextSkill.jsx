const IconsText = {
    HTML: () => (
        ...
        >
            <svg viewBox="0 0 128 128" fill="#c4c4c4" className="w-6 h-6 md:w-[40px] md:h-[40px] lg:w-10 lg:h-10">
            ...
            <span className="text-sm md:text-base lg:text-lg">HTML</span>
        </div> */}
            <div
                className="dark:bg-[#1010106c] bg-[#f5f7f783] rounded-2xl border border-[#f4f4f40e] p-1 min-h-[50px] w-full flex items-center justify-center shadow-[3px_3px_19px_4px_rgba(0,_0,_0,_0.1)]"
            >
                <div className="flex items-center justify-center">
                    ...
                    <div className="flex flex-1 pl-2">
                        <h2 className="dark:text-[#f4f4f4] text-gray-600 text-[12px] font-semibold">
                            HTML
                        </h2>
        ...
        >
            <div className="flex items-center justify-center">
                <div className="flex items-center">
                    ...
                    <svg viewBox="0 0 128 128" className="w-6 h-6 md:w-[25px] md:h-[25px]">
                        <path fill="url(#a)" d="M66.958.825a6.07 6.07 0 0 0-6.035 0L11.103 29.76c-1.895 1.072-2.96 3.095-2.96 5.24v57.988c0 2.143 1.183 4.167 2.958 5.24l49.82 28.934a6.07 6.07 0 0 0 6.036 0l49.82-28.935c1.894-1.072 2.958-3.096 2.958-5.24V35c0-2.144-1.183-4.167-2.958-5.24z"></path><path fill="url(#b)" d="M116.897 29.76 66.841.825A8.161 8.161 0 0 0 65.302.23L9.21 96.798a6.251 6.251 0 0 0 1.657 1.43l50.057 28.934c1.42.833 3.076 1.072 4.615.595l52.66-96.925a3.702 3.702 0 0 0-1.302-1.072z"></path><path fill="url(#c)" d="M116.898 98.225c1.42-.833 2.485-2.262 2.958-3.81L65.066.108c-1.42-.238-2.959-.119-4.26.715L11.104 29.639l53.606 98.355c.71-.12 1.54-.358 2.25-.715z"></path><defs><linearGradient id="a" x1="34.513" x2="27.157" y1="15.535" y2="30.448" gradientTransform="translate(-129.242 -73.715) scale(6.18523)" gradientUnits="userSpaceOnUse"><stop stopColor="#009aff"></stop><stop offset=".33" stopColor="#009aff"></stop><stop offset=".637" stop-color="#009aff"></stop><stop offset=".934" stopColor="#009aff"></stop><stop offset="1" stopColor="#009aff"></stop></linearGradient><linearGradient id="b" x1="30.009" x2="50.533" y1="23.359" y2="8.288" gradientTransform="translate(-129.242 -73.715) scale(6.18523)" gradientUnits="userSpaceOnUse"><stop offset=".138" stopColor="#009aff"></stop><stop offset=".402" stopColor="#009aff"></stop><stop offset=".713" stopColor="#009aff"></stop><stop offset=".908" stopColor="#009aff"></stop></linearGradient><linearGradient id="c" x1="21.917" x2="40.555" y1="22.261" y2="22.261" gradientTransform="translate(-129.242 -73.715) scale(6.18523)" gradientUnits="userSpaceOnUse"><stop offset=".092" stopColor="#009aff"></stop><stop offset=".287" stopColor="#0875c5"></stop><stop offset=".598" stopColor="#0875c5"></stop><stop offset=".862" stopColor="#0875c5"></stop></linearGradient></defs>
                    </svg>
            ...
            <div className="flex items-center justify-center">
                <div className="flex items-center">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 md:w-[25px] md:h-[25px]" version="1.2" viewBox="0 0 1532 1532" width="1532" height="1532">
                        ...
                        <g id="Page-1">
                            <path fill="#009aff" id="UiPath_Logo_full" fillRule="evenodd" class="s0" d="m0 0h1532v1532h-1532zm159.3 1372.7h1213.4v-1213.4h-1213.4zm294.2-977.4v462.7c0 116.4 49 186.9 159.3 186.9 104.2 0 156.3-67.4 156.3-186.9v-462.7h159.3v462.7c0 211.4-116.4 337-318.7 337-196.1 0-312.5-125.6-312.5-337v-462.7zm680.2 95c-54.2 0-98-43.1-98-96.5 0-53.4 43.8-96.5 98-96.5 54.2 0 98.1 43.1 98.1 96.5 0 53.4-43.9 96.5-98.1 96.5zm-79.6 73.5h159.3v622h-159.3z" />
                        </g>
                    </svg>
