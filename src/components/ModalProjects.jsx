    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black/30 backdrop-blur-xl z-50">
            <motion.div
                ...
                rounded-2xl shadow-xl w-[90%] sm:w-[850px] max-h-[90vh] overflow-y-auto p-6 relative"
            >
                <button
                    onClick={onClose}
                ...
                <div className="grid grid-cols-1 gap-2 pt-4 overflow-auto max-h-[80vh] md:max-h-[80vh] p-4 scrollbar-thin" >
                    {data.map((items, idx) => (
