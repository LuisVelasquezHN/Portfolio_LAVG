    ...
    return (
        <div className="flex items-center justify-center pt-6">
            <div className="relative group">
                <button
                    onClick={onClick}
                    className="relative inline-block p-px font-semibold leading-6 text-[#515151] dark:text-[#f4f4f4] 
                    bg-[#e0e0e0] dark:bg-neutral-900 shadow-2xl cursor-pointer rounded-2xl shadow-[#c4c4c4] dark:shadow-[#f4f4f4] 
                    transition-all duration-300 ease-in-out hover:scale-105 active:scale-95 hover:shadow-[#f4f4f4]"
                >
                    <span className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#f4f4f4] via-cyan-500 to-sky-600 
