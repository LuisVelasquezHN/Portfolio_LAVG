...
export const Inicio = () => {
  ...
  return (
    <>
      ...
      <div id='inicio' className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden">
        <HeroParticles />
        <section className="relative z-10 flex flex-col-reverse lg:flex-row justify-center content-center items-center gap-[40px] lg:gap-[80px] w-full max-w-[1100px] px-4 md:px-8 lg:px-0">
          {/* mt-[15vh] md:mt-[30vh] */}
          <Navbar />
          <div className="text-center lg:text-left max-w-[90%] md:max-w-[80%] lg:max-w-[60%]">
            ...
            <AnimatedItem>
            <p className='text-base md:text-xl mt-4 md:mt-6 px-2 md:px-0 text-pretty text-[#515151] dark:text-[#f4f4f4]'>
            ...
            <div className="flex flex-col md:flex-row items-center gap-3">
              <div className='flex flex-row gap-3'>
                <DownloadCVButton
                  ...
                  className='btn-interactive relative flex text-[14px] md:text-base flex-row items-center gap-1 md:gap-2 
              ...
              btn-interactive flex text-[14px] md:text-base flex-row items-center gap-1 md:gap-2   
               rounded-3xl py-2 px-4 mt-2 cursor-pointer border dark:border-[#f4f4f436] text-[#0d639b] dark:text-[#f4f4f4] shadow-[3px_3px_19px_4px_rgba(0,_0,_0,_0.1)] border-[#f4f4f4d0]
               dark:hover:bg-gradient-to-br dark:hover:from-[#0d639b] dark:hover:via-[#020202] dark:hover:to-[#181818]
               hover:bg-gradient-to-br hover:from-[#d6f7ff] hover:via-[#f7f7f7] hover:to-[#e7e7e7]
              '>
              ...
              btn-interactive flex text-base flex-row gap-2
               rounded-3xl py-2 px-4 mt-2 cursor-pointer border dark:border-[#f4f4f436] text-[#0d639b] dark:text-[#f4f4f4] shadow-[3px_3px_19px_4px_rgba(0,_0,_0,_0.1)] border-[#f4f4f4d0]
               dark:hover:bg-gradient-to-br dark:hover:from-[#0d639b] dark:hover:via-[#020202] dark:hover:to-[#181818]
               hover:bg-gradient-to-br hover:from-[#d6f7ff] hover:via-[#f7f7f7] hover:to-[#e7e7e7]
              '>
              ...
              btn-interactive flex text-base flex-row 
               rounded-3xl py-2 px-4 mt-2 cursor-pointer border dark:border-[#f4f4f436] text-[#0d639b] dark:text-[#f4f4f4] shadow-[3px_3px_19px_4px_rgba(0,_0,_0,_0.1)] border-[#f4f4f4d0]
               dark:hover:bg-gradient-to-br dark:hover:from-[#0d639b] dark:hover:via-[#020202] dark:hover:to-[#181818]
               hover:bg-gradient-to-br hover:from-[#d6f7ff] hover:via-[#f7f7f7] hover:to-[#e7e7e7]
              '>
          ...
          <motion.div
            className="relative w-60 h-60 md:w-80 md:h-80 aspect-square flex justify-center items-center"
          ...
          >
            ...
            <img
              ...
              src="/personal.webp"
              alt="Luis Velasquez - Desarrollador Full Stack" />
          </motion.div>
      ...
      <AnimatedSection direction="up" className="section p-3 mt-[10vh] scroll-m-20 w-full container lg:max-w-5xl">
        <section id="about">
        <AnimatedItem>
