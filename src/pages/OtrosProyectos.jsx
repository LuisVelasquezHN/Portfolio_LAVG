            ...
            <section className='section p-3 hiddenObs2 mt-[10vh] scroll-m-20 w-full container lg:max-w-5xl md:max-w-xl'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4">
                    {projects.map((project) => (
                        ...
                        >
                            <div className="absolute inset-0 bg-[#2f97e0] dark:bg-[#031d2f] opacity-50 h-20 md:h-15 mt-auto group-hover:opacity-70 transition-opacity duration-300"></div>
