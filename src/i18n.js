      ...
      es: {
        translation: {
          ...
          experience: {
            ...
            descripcionCC: `Liderazgo en el diseño, desarrollo y mantenimiento de los sitios web oficiales de la compañía a nivel regional. Creación de sistemas de gestión empresarial (ERP/CRM): Talento Humano, Dispatch & Logística, Negocios Corporativos, Gobernanza y Documentación (DMS), Portal Corporativo y CMS. Implementación de flujos ETL y rutinas automatizadas para la extracción y manipulación de bases de datos, asegurando la actualización diaria de reportes críticos. Ecosistema Cloud (AWS): Administración de infraestructura en la nube, incluyendo CI/CD, despliegue de proyectos monolitos en EC2 con Docker, gestión de Parameter Store, configuración de Route 53, almacenamiento en S3 y distribución con CloudFront. Elaboración y mantenimiento de documentación técnica detallada.`,
            puestoFree: 'Desarrollador Full Stack & Consultor Tecnológico (Freelance)',
            empresaFree: '',
            tiempoFree: 'Enero 2023 - Actualidad',
            descripcionFree: `Desarrollo a la Medida: Diseño, arquitectura y mantenimiento de sitios web y aplicaciones web escalables utilizando frameworks modernos como React y Astro. Sistemas CRM & Gestión: Creación de sistemas CRM personalizados con visualización de procesos mediante tableros Kanban y gestión dinámica de leads. Integraciones & Automatización: Implementación de flujos de trabajo automatizados con n8n e Inteligencia Artificial (OpenAI) para la optimización de procesos de negocio. Conectividad: Integración de landing pages con sistemas CRM y servicios de terceros a través de APIs REST y automatización de notificaciones por correo electrónico. Análisis de Datos: Desarrollo de dashboards interactivos con actualización de datos en tiempo real para la toma de decisiones estratégicas. Ecosistema Cloud (AWS): Administración de infraestructura en la nube, incluyendo gestión de identidades (IAM), almacenamiento en S3, despliegue en instancias EC2 y configuraciones de CloudFront.`,
